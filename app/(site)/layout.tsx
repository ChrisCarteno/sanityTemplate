    ...
    <html lang="en">
      ...
      <header>
        ...
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
          ...
          <a href="tel:17604429714" className="mr-6 text-sm  text-gray-500 dark:text-white hover:underline">(760) 442-9714</a>
        </div>
          </div>
        </nav>
        ...
        <footer className="bg-white rounded-lg shadow dark:bg-gray-800 mt-auto">
          <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; 2023 <a href="https://www.christiancarteno.com/" className="hover:underline">Christian&trade;</a>. All Rights Reserved.</span>
